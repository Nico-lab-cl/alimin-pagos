...
export default function MaintenancePage() {
  return (
    <div className="min-h-screen emerald-mesh relative flex flex-col items-center justify-between p-4 sm:p-6 md:p-10 text-white overflow-hidden select-none">
      ...
      <div className="absolute bottom-10 right-10 w-[250px] sm:w-[400px] h-[250px] sm:h-[400px] bg-[#76d845]/10 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xl sm:text-2xl font-black tracking-tight text-white font-outfit uppercase">
              ALIMIN <span className="text-[#76d845]">SPA</span>
            </span>
      ...
      <main className="w-full max-w-xl my-auto z-10 py-6">
        <div className="glass-card rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl relative overflow-hidden backdrop-blur-2xl">
          ...
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#4ba646] via-[#a4e878] to-[#76d845]" />

          {/* Floating Icon Orb */}
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-[#0a2a2a] to-[#061010] border border-[#76d845]/40 flex items-center justify-center shadow-2xl group">
                <Wrench className="w-10 h-10 sm:w-12 sm:h-12 text-[#76d845] animate-bounce" />
              </div>
          ...
          <div className="text-center space-y-3 mb-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#76d845]/10 border border-[#76d845]/30 text-[#a4e878] text-xs font-bold tracking-wider uppercase">
            ...
            <p className="text-sm sm:text-base text-gray-300 font-inter leading-relaxed max-w-md mx-auto">
              En <strong className="text-[#a4e878] font-semibold">Alimin SPA</strong> estamos llevando a cabo optimizaciones en nuestros servidores para ofrecerte una experiencia de pago y gestión más rápida, fluida y segura.
            </p>
          </div>
          ...
          <div className="bg-black/30 rounded-2xl p-4 border border-white/5 space-y-3 mb-8">
            ...
            <div className="flex items-center gap-3 text-xs text-gray-300">
              <div className="w-4 h-4 rounded-full border-2 border-t-transparent border-[#76d845] animate-spin shrink-0" />
              <span className="text-[#a4e878]">Despliegue de Mejoras de Rendimiento</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <button
              ...
              className="w-full sm:w-1/2 btn-brand py-3 px-4 rounded-xl flex items-center justify-center gap-2 text-xs cursor-pointer shadow-lg"
            >
            ...
            >
              <Lock className="w-4 h-4 text-[#76d845]" />
      ...
      <footer className="w-full max-w-5xl z-10 text-center py-4 text-xs text-gray-400 space-y-1">
        ...
        <p className="text-[11px] text-gray-400">
          © {new Date().getFullYear()} <span className="text-[#76d845]">Alimin SPA</span> — Solidez e Innovación Inmobiliaria
        </p>
      </footer>
    </div>
  );
